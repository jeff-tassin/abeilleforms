...
public class SettingsNames {
	 ...
	 * <tt>TAB_SIZE</tt> and <tt>SPACES_PER_TAB</tt>. Values:
	 * java.lang.Integer instances
	 */
	 ...
	 * It can be added through <tt>CUSTOM_ACTION_LIST</tt>. The original
	 * abbreviation string is first removed from the text before the action is
	 * executed. If there is the same abbreviation in the <tt>ABBREV_MAP</tt>
	 * map it has a precedence over the <tt>ABBREV_ACTION_MAP</tt>. Values:
	 ...
	 * org.netbeans.editor.Acceptor instances
	 */
	public static final String ABBREV_ADD_TYPED_CHAR_ACCEPTOR = "abbrev-add-typed-char-acceptor"; // NOI18N
	...
	/**
	 * Whether to display line numbers when printing to the printer. Values:
	 * java.lang.Boolean instances
	 */
	...
	/*
	 * Find properties. They are read by FindSupport when its instance is being
	 * initialized. FIND_WHAT: java.lang.String - search expression
	 * FIND_REPLACE_BY: java.lang.String - replace string FIND_HIGHLIGHT_SEARCH:
	 * java.lang.Boolean - highlight matching strings in text FIND_INC_SEARCH:
	 * java.lang.Boolean - show matching strings immediately
	 * FIND_BACKWARD_SEARCH: java.lang.Boolean - search in backward direction
	 * FIND_WRAP_SEARCH: java.lang.Boolean - if end of doc reached, start from
	 * begin FIND_MATCH_CASE: java.lang.Boolean - match case of letters
	 * FIND_SMART_CASE: java.lang.Boolean - case insensitive search if
	 * FIND_MATCH_CASE is false and all letters of FIND_WHAT are small, case
	 * sensitive otherwise FIND_WHOLE_WORDS: java.lang.Boolean - match only
	 * whole words FIND_REG_EXP: java.lang.Boolean - use regular expressions in
	 * search expr FIND_HISTORY: java.util.List - History of search expressions
	...
	/**
	 * Finder for finding the next word. If it's not set, the
	 * <tt>FinderFactory.NextWordFwdFinder</tt> is used. Values:
	 * org.netbeans.editor.Finder
	 */
	public static final String NEXT_WORD_FINDER = "next-word-finder"; // NOI18N

	/**
	 * Finder for finding the previous word. If it's not set, the
	 * <tt>FinderFactory.WordStartBwdFinder</tt> is used. Values:
	 * org.netbeans.editor.Finder
	 */
	 ...
	 * the line. Values: java.lang.Boolean instances
	 */
	 ...
	 * <tt>TOKEN_CONTEXT_LIST</tt> holds the list of token contexts that can
