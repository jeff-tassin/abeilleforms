...
/**
 * List of all bookmarks attached to document. This is helper class for storage
...
public class Bookmarks {
	...
	public interface Bookmark {
		...
		/**
		 * Method which is called when document is going to be closed. Bookmark
		 * can handle this change of state if necessary.
		 */
		public void remove();
	}
