...
class DrawLayerList {
	 ...
	 * 
	 * @param layer
	 *            layer to add to the layer list
	 * @return true when new layer was added false otherwise. The layer is not
	 *         added if there is already a layer with the same name. There can
	 *         be a layer with the same visibility like the layer being added.
	 */
	 ...
	 * 
	 * @param layer
	 *            layer to remove from the layer list
	 */
	...
	/**
	 * Get the snapshot of the current layers. This is useful for drawing
