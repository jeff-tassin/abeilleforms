 ...
 * doesn't prevent it to be garbage collected. The calls to the
 * <code>actionPerformed</code> are automatically propagated to the source
 * action listener.
 * 
...
public class WeakTimerListener implements ActionListener {
	 ...
	 * 
	 * @param source
	 *            source action listener to which this listener delegates.
	 * @param stopTimer
	 *            whether the timer should be stopped automatically when the
	 *            timer fires and the source listener was garbage collected.
	 */
