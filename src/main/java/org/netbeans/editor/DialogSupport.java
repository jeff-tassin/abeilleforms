...
public class DialogSupport {
	 ...
	 * 
	 * @param title
	 *            The title of created dialog.
	 * @param panel
	 *            The content of the dialog to be displayed.
	 * @param modal
	 *            Whether the dialog should be modal.
	 * @param buttons
	 *            The array of JButtons to be added to the dialog.
	 * @param sidebuttons
	 *            The buttons could be placed under the panel (false), or on the
	 *            right side of the panel (true).
	 * @param defaultIndex
	 *            The index of default button in the buttons array, if <CODE>index <
	 *            0</CODE>, no default button is set.
	 * @param cancelIndex
	 *            The index about cancel button - the button that will be
	 *            <I>pressed</I> when closing the dialog.
	 * @param listener
	 *            The listener which will be notified of all button events.
	 * @return newly created <CODE>Dialog</CODE>
	 */
	public static Dialog createDialog(String title, JPanel panel, boolean modal, JButton[] buttons, boolean sidebuttons, int defaultIndex, int cancelIndex,
	...
	/**
	 * The method for setting custom factory for creating dialogs via the
	 * {@link #createDialog(java.lang.String, javax.swing.JPanel, boolean, javax.swing.JButton[], boolean, int, int, java.awt.event.ActionListener) createDialog}
	 * method. If no factory is set, the
	 * {@link DialogSupport.DefaultDialogFactory DefaultDialogFactory} will be
	 * used.
	 * 
	 * @param factory
	 *            the {@link DialogSupport.DialogFactory DialogFactory}
	...
	/**
	 * DialogFactory implementation is a class responsible for providing proper
	 * implementation of Dialog containing required widgets. It can provide the
	 * dialog itself or delegate the functionality to another piece of code, e.g
	...
	public static interface DialogFactory {
		 ...
		 *            The array of JButtons to be added to the dialog.
		 * @param sidebuttons
		 *            The buttons could be placed under the panel (false), or on
		 *            the right side of the panel (true).
		 * @param defaultIndex
		 *            The index of default button in the buttons array, if
		 *            <CODE>index < 0</CODE>, no default button is set.
		 * @param cancelIndex
		 *            The index of cancel button - the button that will be
		 *            <I>pressed</I> when closing the dialog.
		 * @param listener
		 *            The listener which will be notified of all button events.
		 * @return newly created <CODE>Dialog</CODE>
		 */
		public Dialog createDialog(String title, JPanel panel, boolean modal, JButton[] buttons, boolean sidebuttons, int defaultIndex, int cancelIndex,
				ActionListener listener);
	}
	...
	private static class DefaultDialogFactory extends WindowAdapter implements DialogFactory, ActionListener {
		...
		public Dialog createDialog(String title, JPanel panel, boolean modal, JButton[] buttons, boolean sidebuttons, int defaultIndex, int cancelIndex,
			...
			if (cancelIndex >= 0) {
				...
				d.getRootPane().registerKeyboardAction(this, KeyStroke.getKeyStroke(KeyEvent.VK_ESCAPE, 0, true), JComponent.WHEN_IN_FOCUSED_WINDOW);
