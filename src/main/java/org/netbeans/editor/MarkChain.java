...
public class MarkChain {
	 ...
	 * the mark was not created, because there already was some on this
	...
	protected MarkFactory.ChainDrawMark createMark() {
		...
		mark.backwardBias = true; // stay at line begining
	 ...
	 * 
	 * @return true if the mark was added false if there's already mark at that
	 *         pos
	 */
	...
	/**
	 * Toggle the mark so that if it didn't exist it is created and if it
	 * existed it's removed
	 * 
	 * @return true if the new mark was added false if the existing mark was
	 *         removed
	 */
