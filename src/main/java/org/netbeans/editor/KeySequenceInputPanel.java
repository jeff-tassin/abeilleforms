 ...
 * {@link #getKeySequence} One instance could be reused. {@link #clear} When
 * actual keySequence changes, it fires PropertyChangeEvent of property
 * {@link #PROP_KEYSEQUENCE}. There is additional label on the bottom, which
 * could be set with {@link #setInfoText} to pass some information to user.
 * 
...
public class KeySequenceInputPanel extends javax.swing.JPanel {
	...
	private boolean isModifier(int keyCode) {
		return (keyCode == KeyEvent.VK_ALT) || (keyCode == KeyEvent.VK_ALT_GRAPH) || (keyCode == KeyEvent.VK_CONTROL) || (keyCode == KeyEvent.VK_SHIFT)
