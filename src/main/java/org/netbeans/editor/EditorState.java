...
/**
 * This singleton class is an editor state encapsulation object. Every part of
 ...
 * indexed by state-holders' names. Typical usage is <CODE>myState =
 * EditorState.get( MY_STATE_NAME );</CODE> There is no support for state
