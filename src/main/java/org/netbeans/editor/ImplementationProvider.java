...
abstract public class ImplementationProvider {
	...
	/**
	 * This is temporary method which allows core editor to access toggle
	 * breakpoint action. This action is then used when user clicks on glyph
	 * gutter. In next version this should be removed and redesigned as
	 * suggested in issue #16762
	 */
