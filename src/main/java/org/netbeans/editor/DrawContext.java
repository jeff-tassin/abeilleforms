...
public interface DrawContext {
	...
	/**
	 * Get start position of the drawing. This value stays unchanged during the
	 * line-number drawing.
	 */
	public int getStartOffset();

	/**
	 * Get end position of the drawing. This value stays unchanged during the
	 * line-number drawing.
	 */
	public int getEndOffset();

	/**
	 * Is current drawing position at the begining of the line? This flag is
	 * undefined for the line-number drawing.
	 */
	public boolean isBOL();

	/**
	 * Is current drawing position at the end of the line This flag is undefined
	 * for the line-number drawing.
	 */
	...
	/**
	 * Get the starting position in the document of the fragment of the token
	 * being drawn.
	 */
	...
	/**
	 * Get the buffer with the characters being drawn. No changes can be done to
	 ...
	 * between <tt>getDrawStartOffset()</tt> and <tt>getDrawEndOffset</tt>
	 * will contain valid characters. However the first token can start even
	 * under <tt>getDrawStartOffset()</tt>. In this case the valid area
	 * starts at <tt>getTokenOffset()</tt> of the first token.
	 */
