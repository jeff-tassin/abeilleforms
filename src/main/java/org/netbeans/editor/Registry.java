...
public class Registry {
	 ...
	 * 
	 * @param docID
	 *            document ID. It can be retrieved from the document by
	 *            <code>getID(doc)</code>.
	 ...
	 * 
	 * @param compID
	 *            component ID. It can be retrieved from the component by
	 *            <code>getID(c)</code>.
	 ...
	 * 
	 * @return ID that the component had in the registry. The possible new ID
	 *         will be different from this one. -1 will be returned if the
	 *         component was not yet added to the registry.
	 */
