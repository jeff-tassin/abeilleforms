...
public class LeafElement extends BaseElement {
	...
	/**
	 * Gets the child element index closest to the given offset. For leaf
	 * element this returns -1.
	 */
	...
	/**
	 * Get child of this element at specified index or itself if the index is
	 * too big
	 */
