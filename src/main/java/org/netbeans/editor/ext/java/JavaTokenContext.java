...
/**
 * Java token-context defines token-ids and token-categories used in Java
 * language.
 * 
...
public class JavaTokenContext extends TokenContext {
	...
	public static final int BREAK_ID = ABSTRACT_ID + 1;
	...
	public static final BaseTokenCategory NUMERIC_LITERALS = new BaseTokenCategory("numeric-literals", NUMERIC_LITERALS_ID);
	...
	public static final BaseTokenID DOUBLE_LITERAL = new BaseTokenID("double-literal", DOUBLE_LITERAL_ID, NUMERIC_LITERALS);
	...
	public static final BaseImageTokenID LSHIFT = new BaseImageTokenID("lshift", LSHIFT_ID, OPERATORS, "<<");

	public static final BaseImageTokenID RSSHIFT = new BaseImageTokenID("rsshift", RSSHIFT_ID, OPERATORS, ">>");

	public static final BaseImageTokenID RUSHIFT = new BaseImageTokenID("rushift", RUSHIFT_ID, OPERATORS, ">>>");
	...
	public static final BaseImageTokenID LSHIFT_EQ = new BaseImageTokenID("lshift-eq", LSHIFT_EQ_ID, OPERATORS, "<<=");

	public static final BaseImageTokenID RSSHIFT_EQ = new BaseImageTokenID("rsshift-eq", RSSHIFT_EQ_ID, OPERATORS, ">>=");

	public static final BaseImageTokenID RUSHIFT_EQ = new BaseImageTokenID("rushift-eq", RUSHIFT_EQ_ID, OPERATORS, ">>>=");

	public static final BaseImageTokenID PLUS_EQ = new BaseImageTokenID("plus-eq", PLUS_EQ_ID, OPERATORS, "+=");

	public static final BaseImageTokenID MINUS_EQ = new BaseImageTokenID("minus-eq", MINUS_EQ_ID, OPERATORS, "-=");

	public static final BaseImageTokenID MUL_EQ = new BaseImageTokenID("mul-eq", MUL_EQ_ID, OPERATORS, "*=");

	public static final BaseImageTokenID DIV_EQ = new BaseImageTokenID("div-eq", DIV_EQ_ID, OPERATORS, "/=");

	public static final BaseImageTokenID AND_EQ = new BaseImageTokenID("and-eq", AND_EQ_ID, OPERATORS, "&=");

	public static final BaseImageTokenID OR_EQ = new BaseImageTokenID("or-eq", OR_EQ_ID, OPERATORS, "|=");

	public static final BaseImageTokenID XOR_EQ = new BaseImageTokenID("xor-eq", XOR_EQ_ID, OPERATORS, "^=");

	public static final BaseImageTokenID MOD_EQ = new BaseImageTokenID("mod-eq", MOD_EQ_ID, OPERATORS, "%=");
	...
	public static final BaseImageTokenID QUESTION = new BaseImageTokenID("question", QUESTION_ID, OPERATORS, "?");
	...
	public static final BaseImageTokenID PLUS_PLUS = new BaseImageTokenID("plus-plus", PLUS_PLUS_ID, OPERATORS, "++");

	public static final BaseImageTokenID MINUS_MINUS = new BaseImageTokenID("minus-minus", MINUS_MINUS_ID, OPERATORS, "--");

	public static final BaseImageTokenID AND_AND = new BaseImageTokenID("and-and", AND_AND_ID, OPERATORS, "&&");

	public static final BaseImageTokenID OR_OR = new BaseImageTokenID("or-or", OR_OR_ID, OPERATORS, "||");

	// Data types
	public static final BaseImageTokenID BOOLEAN = new BaseImageTokenID("boolean", BOOLEAN_ID, KEYWORDS);

	public static final BaseImageTokenID BYTE = new BaseImageTokenID("byte", BYTE_ID, KEYWORDS);

	public static final BaseImageTokenID CHAR = new BaseImageTokenID("char", CHAR_ID, KEYWORDS);

	public static final BaseImageTokenID DOUBLE = new BaseImageTokenID("double", DOUBLE_ID, KEYWORDS);

	public static final BaseImageTokenID FLOAT = new BaseImageTokenID("float", FLOAT_ID, KEYWORDS);

	public static final BaseImageTokenID INT = new BaseImageTokenID("int", INT_ID, KEYWORDS);

	public static final BaseImageTokenID LONG = new BaseImageTokenID("long", LONG_ID, KEYWORDS);

	public static final BaseImageTokenID SHORT = new BaseImageTokenID("short", SHORT_ID, KEYWORDS);

	// Void type
	public static final BaseImageTokenID VOID = new BaseImageTokenID("void", VOID_ID, KEYWORDS);

	// Rest of the keywords
	public static final BaseImageTokenID ABSTRACT = new BaseImageTokenID("abstract", ABSTRACT_ID, KEYWORDS);

	public static final BaseImageTokenID BREAK = new BaseImageTokenID("break", BREAK_ID, KEYWORDS);

	public static final BaseImageTokenID CASE = new BaseImageTokenID("case", CASE_ID, KEYWORDS);

	public static final BaseImageTokenID CATCH = new BaseImageTokenID("catch", CATCH_ID, KEYWORDS);

	public static final BaseImageTokenID CLASS = new BaseImageTokenID("class", CLASS_ID, KEYWORDS);

	public static final BaseImageTokenID CONST = new BaseImageTokenID("const", CONST_ID, KEYWORDS);

	public static final BaseImageTokenID CONTINUE = new BaseImageTokenID("continue", CONTINUE_ID, KEYWORDS);

	public static final BaseImageTokenID DEFAULT = new BaseImageTokenID("default", DEFAULT_ID, KEYWORDS);

	public static final BaseImageTokenID DO = new BaseImageTokenID("do", DO_ID, KEYWORDS);

	public static final BaseImageTokenID ELSE = new BaseImageTokenID("else", ELSE_ID, KEYWORDS);

	public static final BaseImageTokenID EXTENDS = new BaseImageTokenID("extends", EXTENDS_ID, KEYWORDS);

	public static final BaseImageTokenID FALSE = new BaseImageTokenID("false", FALSE_ID, KEYWORDS);

	public static final BaseImageTokenID FINAL = new BaseImageTokenID("final", FINAL_ID, KEYWORDS);

	public static final BaseImageTokenID FINALLY = new BaseImageTokenID("finally", FINALLY_ID, KEYWORDS);

	public static final BaseImageTokenID FOR = new BaseImageTokenID("for", FOR_ID, KEYWORDS);

	public static final BaseImageTokenID GOTO = new BaseImageTokenID("goto", GOTO_ID, KEYWORDS);

	public static final BaseImageTokenID IF = new BaseImageTokenID("if", IF_ID, KEYWORDS);

	public static final BaseImageTokenID IMPLEMENTS = new BaseImageTokenID("implements", IMPLEMENTS_ID, KEYWORDS);

	public static final BaseImageTokenID IMPORT = new BaseImageTokenID("import", IMPORT_ID, KEYWORDS);

	public static final BaseImageTokenID INSTANCEOF = new BaseImageTokenID("instanceof", INSTANCEOF_ID, KEYWORDS);

	public static final BaseImageTokenID INTERFACE = new BaseImageTokenID("interface", INTERFACE_ID, KEYWORDS);

	public static final BaseImageTokenID NATIVE = new BaseImageTokenID("native", NATIVE_ID, KEYWORDS);

	public static final BaseImageTokenID NEW = new BaseImageTokenID("new", NEW_ID, KEYWORDS);

	public static final BaseImageTokenID NULL = new BaseImageTokenID("null", NULL_ID, KEYWORDS);

	public static final BaseImageTokenID PACKAGE = new BaseImageTokenID("package", PACKAGE_ID, KEYWORDS);

	public static final BaseImageTokenID PRIVATE = new BaseImageTokenID("private", PRIVATE_ID, KEYWORDS);

	public static final BaseImageTokenID PROTECTED = new BaseImageTokenID("protected", PROTECTED_ID, KEYWORDS);

	public static final BaseImageTokenID PUBLIC = new BaseImageTokenID("public", PUBLIC_ID, KEYWORDS);

	public static final BaseImageTokenID RETURN = new BaseImageTokenID("return", RETURN_ID, KEYWORDS);

	public static final BaseImageTokenID STATIC = new BaseImageTokenID("static", STATIC_ID, KEYWORDS);

	public static final BaseImageTokenID STRICTFP = new BaseImageTokenID("strictfp", STRICTFP_ID, KEYWORDS);

	public static final BaseImageTokenID SUPER = new BaseImageTokenID("super", SUPER_ID, KEYWORDS);

	public static final BaseImageTokenID SWITCH = new BaseImageTokenID("switch", SWITCH_ID, KEYWORDS);

	public static final BaseImageTokenID SYNCHRONIZED = new BaseImageTokenID("synchronized", SYNCHRONIZED_ID, KEYWORDS);

	public static final BaseImageTokenID THIS = new BaseImageTokenID("this", THIS_ID, KEYWORDS);

	public static final BaseImageTokenID THROW = new BaseImageTokenID("throw", THROW_ID, KEYWORDS);

	public static final BaseImageTokenID THROWS = new BaseImageTokenID("throws", THROWS_ID, KEYWORDS);

	public static final BaseImageTokenID TRANSIENT = new BaseImageTokenID("transient", TRANSIENT_ID, KEYWORDS);

	public static final BaseImageTokenID TRUE = new BaseImageTokenID("true", TRUE_ID, KEYWORDS);

	public static final BaseImageTokenID TRY = new BaseImageTokenID("try", TRY_ID, KEYWORDS);

	public static final BaseImageTokenID VOLATILE = new BaseImageTokenID("volatile", VOLATILE_ID, KEYWORDS);

	public static final BaseImageTokenID WHILE = new BaseImageTokenID("while", WHILE_ID, KEYWORDS);

	// Incomplete and error token-ids
	public static final BaseTokenID INCOMPLETE_STRING_LITERAL = new BaseTokenID("incomplete-string-literal", INCOMPLETE_STRING_LITERAL_ID, ERRORS);

	public static final BaseTokenID INCOMPLETE_CHAR_LITERAL = new BaseTokenID("incomplete-char-literal", INCOMPLETE_CHAR_LITERAL_ID, ERRORS);

	public static final BaseTokenID INCOMPLETE_HEX_LITERAL = new BaseTokenID("incomplete-hex-literal", INCOMPLETE_HEX_LITERAL_ID, ERRORS);
	...
	public static final BaseTokenID INVALID_OCTAL_LITERAL = new BaseTokenID("invalid-octal-literal", INVALID_OCTAL_LITERAL_ID, ERRORS);

	public static final BaseTokenID INVALID_COMMENT_END = new BaseTokenID("invalid-comment-end", INVALID_COMMENT_END_ID, ERRORS);
	...
	static {
		BaseImageTokenID[] kwds = new BaseImageTokenID[] { ABSTRACT, BREAK, CASE, CATCH, CLASS, CONST, CONTINUE, DEFAULT, DO, ELSE, EXTENDS, FALSE, FINAL,
				FINALLY, FOR, GOTO, IF, IMPLEMENTS, IMPORT, INSTANCEOF, INTERFACE, NATIVE, NEW, NULL, PACKAGE, PRIVATE, PROTECTED, PUBLIC, RETURN, STATIC,
				SUPER, SWITCH, SYNCHRONIZED, THIS, THROW, THROWS, TRANSIENT, TRUE, TRY, VOLATILE, WHILE, BOOLEAN, BYTE, CHAR, DOUBLE, FLOAT, INT, LONG, SHORT,
				VOID };
