 ...
 * It maintains its own history (stored in EditorState). For proper history
 * functionality, it is needed to call <CODE>updateHistory()</CODE> for valid
 * inserts.
 * 
...
public class GotoDialogPanel extends JPanel {
	 ...
	 * 
	 * @param content
	 *            The List of items to be shown in the combo
	 */
	...
	/**
	 * This method is to be called when caller wishes to add the current content
	 * of the input filed to the history
	 */
